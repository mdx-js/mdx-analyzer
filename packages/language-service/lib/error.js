 ...
 * @returns {object is VFileMessage} Whether or not the object is a vfile message.
 */
 ...
 *
 * @param {import('typescript')} ts The TypeScript module to use.
 * @param {unknown} error The error to represent.
 * @returns {[DiagnosticWithLocation]} The error as a TypeScript diagnostic.
 */
