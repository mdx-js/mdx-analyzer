  ...
  assert.deepEqual(code.embeddedCodes, [
    {
      ...
      mappings: [
        ...
        },
        {
          ...
          generatedOffsets: [762, 776, 798, 812, 829, 843, 870, 885, 901],
  ...
  assert.deepEqual(code.embeddedCodes, [
    {
      ...
      mappings: [
        ...
        },
        {
          ...
          generatedOffsets: [762, 808, 852, 910, 939, 1003],
  ...
  assert.deepEqual(code.embeddedCodes, [
    {
      ...
      mappings: [
        ...
        },
        {
          ...
          generatedOffsets: [762, 796, 807, 820, 858, 872, 886, 922],
  ...
  assert.deepEqual(code.embeddedCodes, [
    {
      ...
      mappings: [
        ...
        },
        {
          ...
          generatedOffsets: [762, 774, 787, 803],
          lengths: [7, 1, 11, 9],
          data: {
            completion: true,
            format: false,
  ...
  assert.deepEqual(code.embeddedCodes, [
    {
      ...
      mappings: [
        ...
        },
        {
          ...
          generatedOffsets: [778, 799, 812, 837],
          lengths: [7, 1, 11, 9],
          data: {
            completion: true,
            format: false,
