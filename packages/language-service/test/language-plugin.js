  ...
  assert.deepEqual(code.embeddedCodes, [
    {
      ...
      mappings: [
        {
          sourceOffsets: [0, 0, 15],
          generatedOffsets: [27, 78, 86],
          lengths: [0, 8, 21],
          data: {
            completion: true,
            format: true,
  ...
  assert.deepEqual(code.embeddedCodes, [
    {
      ...
      mappings: [
        {
          sourceOffsets: [0, 0, 22],
          generatedOffsets: [27, 78, 93],
          lengths: [0, 15, 21],
          data: {
            completion: true,
            format: true,
  ...
  assert.deepEqual(code.embeddedCodes, [
    {
      ...
      mappings: [
        {
          sourceOffsets: [0, 0, 42],
          generatedOffsets: [27, 78, 775],
          lengths: [0, 27, 24],
          data: {
            completion: true,
            format: true,
  ...
  assert.deepEqual(code.embeddedCodes, [
    {
      ...
      mappings: [
        {
          generatedOffsets: [27, 78, 144, 220],
          sourceOffsets: [0, 0, 66, 142],
          lengths: [0, 65, 75, 62],
          data: {
            completion: true,
            format: true,
...
test('remark-mdx-frontmatter type', () => {
  const plugin = createMdxLanguagePlugin(
    [remarkFrontmatter],
  ...
  assert.ok(code instanceof VirtualMdxCode)
  assert.ifError(code.error)
  assert.deepEqual(code.embeddedCodes?.[0], {
    id: 'jsx',
    languageId: 'javascriptreact',
    mappings: [
      {
...
test('remark-mdx-frontmatter type w/ yaml', () => {
  const plugin = createMdxLanguagePlugin(
    [remarkFrontmatter],
    [remarkMdxFrontmatter({type: "import('./frontmatter.js').Frontmatter"})],
    false
  ...
  const snapshot = snapshotFromLines('---', 'title: hello', '---', '')
  ...
  assert.deepEqual(code.embeddedCodes?.[0], {
    ...
    snapshot: snapshotFromLines(
      ...
      '/** Generated by [remark-mdx-frontmatter](https://github.com/remcohaszing/remark-mdx-frontmatter) */',
      "export const frontmatter = /** @type {import('./frontmatter.js').Frontmatter} */ (undefined)",
      'const __mdxFrontmatterValue = ({"title": "hello"})',
      "/** @type {import('./frontmatter.js').Frontmatter} */",
      'const __mdxFrontmatterChecked = __mdxFrontmatterValue',
