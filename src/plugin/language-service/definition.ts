...
import { isNotNullOrUndefined, isMdxFilePath } from '../utils';
        ...
        return {
            ...
            definitions: definition.definitions
                .map((def) => {
                    ...
                    logger.log('[getDefinitionAndBoundSpan]: ' + + def.fileName + '/' +  JSON.stringify(textSpan))
                    if (!textSpan) {
